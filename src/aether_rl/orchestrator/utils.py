...
from aether_rl.utils.logger import InterceptHandler, get_logger, setup_logger
...
def intercept_vf_logging(logger: str = "verifiers", level: str = "DEBUG", prefix: str | None = None):
    """Intercepts verifiers logging and routes through aether-rl logger with optional prefix."""
...
def setup_env_server_logging(log_level: str, json_logging: bool = False) -> None:
    """Configure logging for an env-server process: aether-rl's logger + routing v1's stdlib
