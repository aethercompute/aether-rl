...
if TYPE_CHECKING:
    ...
    from aether_rl.orchestrator.ckpt import CheckpointManager
    from aether_rl.transport.base import TrainingBatchSender
    from aether_rl.utils.client import InferencePool
    from aether_rl.utils.monitor.base import Monitor
import aether_rl._compat  # noqa: F401 — patch ring_flash_attn compat before transitive imports
from aether_rl.configs.orchestrator import OrchestratorConfig
from aether_rl.orchestrator.ckpt import setup_ckpt_manager
from aether_rl.orchestrator.dispatcher import DispatcherMetrics, DispatcherMode, RolloutDispatcher
from aether_rl.orchestrator.envs import EvalEnvs, TrainEnvs
from aether_rl.orchestrator.eval_sink import EvalSink
from aether_rl.orchestrator.eval_source import EvalSource
from aether_rl.orchestrator.filters import setup_filters
from aether_rl.orchestrator.inference_metrics import InferenceMetricsCollector
from aether_rl.orchestrator.patches import (
    monkey_patch_chat_completion_logprobs,
    monkey_patch_oai_iterable_types,
)
from aether_rl.orchestrator.periodic_logger import PeriodicLogger
from aether_rl.orchestrator.train_sink import TrainSink
from aether_rl.orchestrator.train_source import TrainSource
from aether_rl.orchestrator.types import (
    EvalBatch,
    Policy,
    Progress,
    Rollout,
...
from aether_rl.orchestrator.utils import (
    get_weight_dir,
...
from aether_rl.orchestrator.watcher import WeightWatcher
from aether_rl.trainer.model import setup_tokenizer
from aether_rl.trainer.rl.broadcast.nixl.model_express import ModelExpressSession
from aether_rl.transport import TrainingBatch, setup_training_batch_sender
from aether_rl.utils.async_utils import EventLoopLagMonitor, EventLoopLagStats, safe_cancel
from aether_rl.utils.client import init_nccl_broadcast, init_nixl_broadcast
from aether_rl.utils.config import to_toml_dict
from aether_rl.utils.heartbeat import Heartbeat
from aether_rl.utils.logger import format_time, get_logger, setup_logger
from aether_rl.utils.monitor import setup_monitor
from aether_rl.utils.pathing import get_log_dir, get_trace_path
from aether_rl.utils.usage_reporter import UsageReporter
from aether_rl.utils.utils import (
    clean_exit,
...
class Orchestrator:
    ...
    async def setup(self) -> None:
        ...
        # The one model aether-rl hosts: the live policy. Frozen model
