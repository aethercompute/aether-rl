...
:class:`~aether_rl.orchestrator.sampler.Sampler`, and sample construction
...
aether-rl hosts exactly one model — the trainable policy, whose pool every
...
from aether_rl.configs.algorithm import ActionLossType, AlgoConfig, FrozenModelConfig
...
async def connect_frozen_pool(
    ...
    ready. The endpoint is externally hosted — aether-rl connects and waits,
    never launches.
