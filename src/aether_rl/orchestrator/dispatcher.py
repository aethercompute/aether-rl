...
from aether_rl.utils.async_utils import safe_cancel, safe_cancel_all
from aether_rl.utils.client import InferencePool, client_identity
...
class RolloutDispatcher:
    ...
    async def emit_episode(self, meta: InflightRollout, group: GroupState | None, rollouts: list[Rollout]) -> None:
        """Stamp aether-rl metadata onto one completed episode and put it on
