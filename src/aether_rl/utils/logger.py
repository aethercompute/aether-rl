...
class InterceptHandler(logging.Handler):
    """Intercept standard logging library and routes to our aether-rl logger with specified prefix."""
...
def setup_logger(
    ...
    # NOTE: We are creating a new "module-level" logger instance for aether-rl so that third-party code cannot "hijack" our logger
