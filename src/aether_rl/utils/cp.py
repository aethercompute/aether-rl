...
# ruff: noqa: I001 — `aether_rl._compat` must run before `ring_flash_attn` imports below.
import aether_rl._compat  # noqa: F401
...
def setup_cp_attention_params(
    ...
    *,
    ...
    if cp_style == "ring":
        ...
        # back into aether_rl.utils — top-level import would deadlock at startup.
        from aether_rl.trainer.models.layers.ulysses_attn import update_ulysses_params
