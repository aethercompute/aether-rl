...
from aether_rl.configs.trainer import NCCLWeightBroadcastConfig
from aether_rl.trainer.conversion_utils import get_max_layer_num
...
from aether_rl.utils.client import NCCL_READY_MARKER
from aether_rl.utils.logger import get_logger
from aether_rl.utils.nccl import disable_nccl_p2p_if_unavailable
from aether_rl.utils.pathing import sync_wait_for_path
from aether_rl.utils.utils import get_broadcast_dir, get_step_path
from aether_rl.utils.vlm import get_layer_prefix
...
def preprocess_layer_checkpoint(
    ...
    if isinstance(model, PreTrainedModelAetherRL) and model.is_prime_state_dict(layer_state_dict):
