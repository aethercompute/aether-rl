...
from aether_rl.trainer.models.afmoe import AfmoeConfig, AfmoeForCausalLM
from aether_rl.trainer.models.base import PreTrainedModelAetherRL
from aether_rl.trainer.models.glm4_moe import Glm4MoeConfig, Glm4MoeForCausalLM
from aether_rl.trainer.models.glm_moe_dsa import GlmMoeDsaConfig, GlmMoeDsaForCausalLM
from aether_rl.trainer.models.gpt_oss import GptOssConfig, GptOssForCausalLM
from aether_rl.trainer.models.laguna import LagunaConfig, LagunaForCausalLM
from aether_rl.trainer.models.layers.lm_head import PrimeLmOutput, cast_float_and_contiguous
from aether_rl.trainer.models.llama import LlamaForCausalLM
from aether_rl.trainer.models.minimax_m2 import MiniMaxM2Config, MiniMaxM2ForCausalLM
from aether_rl.trainer.models.nemotron_h import NemotronHConfig, NemotronHForCausalLM
from aether_rl.trainer.models.qwen3 import Qwen3ForCausalLM
from aether_rl.trainer.models.qwen3_5 import Qwen3_5ForCausalLM
from aether_rl.trainer.models.qwen3_5_moe import Qwen3_5MoeConfig, Qwen3_5MoeForCausalLM
from aether_rl.trainer.models.qwen3_moe import Qwen3MoeConfig, Qwen3MoeForCausalLM
...
_CUSTOM_CAUSAL_LM_MODELS: tuple[
    tuple[type[PretrainedConfig], type[PreTrainedModelAetherRL]],
    ...,
] = (
...
class AutoModelForCausalLMAetherRL(_BaseAutoModelClass):
    _model_mapping = _CUSTOM_CAUSAL_LM_MAPPING


AutoModelForCausalLMAetherRL = auto_class_update(AutoModelForCausalLMAetherRL, head_doc="causal language modeling")


def get_custom_causal_lm_cls(model_config: PretrainedConfig) -> type[PreTrainedModelAetherRL]:
    """Resolve the AetherRL model class from a possibly non-AetherRL config instance."""
...
def supports_custom_impl(model_config: PretrainedConfig) -> bool:
    """Check if the model configuration supports the custom AetherRL implementation.
...
# Mapping from HF composite VLM model_type to custom AetherRL class.
...
def get_custom_vlm_cls(model_config: PretrainedConfig) -> type | None:
    """Return the custom AetherRL VLM class for this config, or None if unsupported."""
