...
from aether_rl.trainer.models.glm4_moe.configuration_glm4_moe import Glm4MoeConfig
from aether_rl.trainer.models.glm4_moe.converting_glm4_moe import conversion_chain
...
from aether_rl.trainer.models.layers.moe import MoE, MoEArgs
...
@auto_docstring
class Glm4MoePreTrainedModel(PreTrainedModelAetherRL):
    ...
    def is_prime_state_dict(cls, state_dict: dict[str, Tensor]) -> bool:
        """Check if the state dict contains MoE layers in AetherRL training format."""
