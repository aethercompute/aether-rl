...
from aether_rl.utils.vlm import get_final_logit_softcapping
...
def inject_prime_lm_head(
    ...
    """
    Inject an AetherRL LM head into a model.
    ...
    if final_logit_softcapping:
        from aether_rl.trainer.models.layers.lm_head_gemma import inject_gemma_lm_head
