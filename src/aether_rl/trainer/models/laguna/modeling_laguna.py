...
from aether_rl.trainer.models.laguna.configuration_laguna import LagunaConfig
from aether_rl.trainer.models.laguna.converting_laguna import conversion_chain
from aether_rl.trainer.models.layers.attn import AttentionConfig, FlashAttention
...
from aether_rl.trainer.models.layers.moe import FeedForward, MoE, MoEArgs
    ...
    def __init__(self, config: LagunaConfig, layer_idx: int):
        ...
        if self.mlp_layer_type == "sparse":
            ...
            if config.moe_router_logit_softcapping:
                raise NotImplementedError("Laguna router logit softcapping is not supported by AetherRL MoE yet.")
...
class LagunaPreTrainedModel(PreTrainedModelAetherRL):
    config: LagunaConfig
