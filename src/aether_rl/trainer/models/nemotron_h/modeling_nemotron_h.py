"""AetherRL implementation of NemotronH (Nemotron-3-Super-120B-A12B).
...
- Attention layers (using shared FlashAttention/SDPA from aether-rl)
"""
...
from aether_rl.trainer.models.layers.cp_mamba import mamba_cp_forward
from aether_rl.trainer.models.layers.lm_head import PrimeLmOutput
from aether_rl.trainer.models.layers.moe import LatentMoE, NemotronHRouter, NonGatedGroupedExperts
from aether_rl.trainer.models.layers.rms_norm import RMSNorm, RMSNormConfig
from aether_rl.trainer.models.layers.ulysses_attn import ULYSSES_PARAMS
from aether_rl.trainer.models.nemotron_h.configuration_nemotron_h import NemotronHConfig
from aether_rl.trainer.models.nemotron_h.converting_nemotron_h import conversion_chain
...
@auto_docstring
class NemotronHPreTrainedModel(PreTrainedModelAetherRL):
