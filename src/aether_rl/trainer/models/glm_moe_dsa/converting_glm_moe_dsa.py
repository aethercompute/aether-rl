"""HF<->AetherRL weight conversion for GLM-MoE-DSA.
...
from aether_rl.trainer.models.fp8 import quantize_to_vllm_kernel_format
from aether_rl.trainer.models.glm4_moe.converting_glm4_moe import glm_moe_layer_ops
...
def convert_tt_layer_to_vllm_kernel(
    ...
    """Convert a single GLM layer from AetherRL format to vLLM kernel format."""
    out: dict[str, Tensor] = {}
