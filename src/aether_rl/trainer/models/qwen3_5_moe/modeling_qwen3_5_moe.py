...
from aether_rl.trainer.models.layers.attn import (
...
from aether_rl.trainer.models.layers.rotary_emb import apply_rotary_pos_emb
from aether_rl.utils.cp import setup_cp_attention_params, shard_for_cp, shard_position_ids_for_cp
...
class Qwen3_5MoePreTrainedModel(PreTrainedModelAetherRL):
...
def _build_text_config(composite_config: PretrainedConfig) -> Qwen3_5MoeConfig:
    """Build custom AetherRL text config from HF's composite VLM config."""
...
class Qwen3_5MoeVLMModel(nn.Module):
    """Composite VLM body: HF vision encoder + custom AetherRL text model."""
