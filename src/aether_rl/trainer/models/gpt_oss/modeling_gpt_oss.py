# GPT-OSS model with AetherRL custom MoE.
#
# This file mirrors HuggingFace's modeling_gpt_oss.py but swaps the experts module for
# `GptOssGroupedExperts` so the LoRA detection logic in `aether_rl/trainer/lora.py` can
...
from aether_rl.trainer.models.gpt_oss.configuration_gpt_oss import GptOssConfig
from aether_rl.trainer.models.gpt_oss.converting_gpt_oss import (
    conversion_chain,
    is_hf_state_dict,
    is_prime_state_dict,
)
from aether_rl.trainer.models.layers.lm_head import PrimeLmOutput
from aether_rl.trainer.models.layers.moe import GptOssGroupedExperts
...
@auto_docstring
class GptOssPreTrainedModel(PreTrainedModelAetherRL):
    config: GptOssConfig
