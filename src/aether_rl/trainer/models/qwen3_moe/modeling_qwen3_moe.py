...
from aether_rl.trainer.models.qwen3_moe.configuration_qwen3_moe import Qwen3MoeConfig
from aether_rl.trainer.models.qwen3_moe.converting_qwen3_moe import conversion_chain
...
@auto_docstring
class Qwen3MoePreTrainedModel(PreTrainedModelAetherRL):
