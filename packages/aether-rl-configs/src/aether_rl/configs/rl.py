...
from aether_rl.configs.inference import WeightBroadcastConfig as InferenceWeightBroadcastConfig
from aether_rl.configs.orchestrator import (
...
from aether_rl.configs.shared import (
    EnvVars,
    FileMonitorConfig,
    SlurmConfig,
    VLMConfig,
...
from aether_rl.utils.config import BaseConfig, find_package_resource
from aether_rl.utils.validation import (
    ...
    def auto_setup_lora(self):
        if self.trainer.model.lora is not None:
            if self.orchestrator.model.lora is None:
                from aether_rl.configs.orchestrator import LoRAConfig
